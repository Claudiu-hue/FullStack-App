...
const AddressForm = ({onTabSwitch}) => {
  ...
  return (
    <form className='md:w-2/3 md:mx-auto px-3 pt-1' onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className='mb-4'>
            <label className='block mb-2 text-sm font-bold text-gray-700' htmlFor="streetAddress">Stress Address</label>
            <input 
                {...register('address')} 
                className='w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-once focus:outline-none focus:shadow-outline'
                id='street address'
                type='text'
